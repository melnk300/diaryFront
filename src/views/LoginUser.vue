<template>
  <div class="main">
    <div class="content">
      ...
      <h5 class="have_account">Do not have account?<router-link to="sign_up" class="link_d">Let's Sing up</router-link></h5>
      <form>
  ...
  methods: {
    ...
    registerUser: function () {
      if (this.password && this.name) {
        axios.post(`http://${process.env.VUE_APP_HOST_CUSTOM}:5000/api/log_check`, {
          login: this.name,
